            ...
            <main className="max-w-[1200px] mx-auto mt-6">
                ...
                <section className="grid grid-cols-2 md:grid-cols-4 gap-4 py-8">
                    {[
                        ...
                        <div key={i} className="bg-slate-900/50 border border-slate-700 rounded-xl p-6 text-center hover:border-cyan-500 transition-all duration-300">
                ...
                <section className="py-10">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {skillData.services.map((service, i) => (
                            <div key={i} className="bg-slate-900/50 border border-slate-700 rounded-xl p-6 hover:border-cyan-500 hover:-translate-y-1 transition-all duration-300 group">
                ...
                <section className="py-10">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {skillData.skills.map((group, i) => (
                            <div key={i} className="bg-slate-900/50 border border-slate-700 rounded-xl p-6">
